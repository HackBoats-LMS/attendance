...
import { getUsers, createUser, deactivateUser } from "@/features/admin/actions";
...
export default function AdminUsersPage() {
  ...
  const handleDelete = async (id: string, name: string) => {
    ...
    try {
      ...
      else { alert(res.error ?? "Failed to deactivate user"); }
          ...
          <table className="w-full text-left text-sm text-ink">
            ...
            <tbody>
              {loading ? (
                ...
                users.map((u) => (
                  <tr key={u.id} className="border-b border-surface-border hover:bg-bg transition-colors">
